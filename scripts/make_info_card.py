...
ROWS = [
    ...
    ("kv", "Focus", "AI/ML, automation, full-stack projects"),
    ("kv", "Builds", "Python apps, web tools, data workflows"),
    ("kv", "Base", "Ahmedabad, Gujarat"),
    ("gap",),
    ("sec", "Stack"),
    ("kv", "Frontend", "HTML, CSS, JS, React"),
    ("kv", "Backend", "Python, Flask/Django, REST APIs"),
    ("kv", "Data/AI", "NumPy, OpenCV, LLM tooling"),
    ("kv", "Ops", "GitHub Actions, Docker, Vercel"),
    ("gap",),
    ("sec", "Highlights"),
    ("bul", "Shipping polished projects with clean UX"),
    ("bul", "Exploring AI workflows and developer tooling"),
    ("bul", "Always learning, building, and sharing what I make"),
]
