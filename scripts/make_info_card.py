...
# ===========================================================================
HOST = "jaypatel2611"   # shown as  jaypatel2611@github  in the header

ROWS = [
    ("host",),
    ("kv", "Now", "B.E. CS & IT @ LJ University"),
    ("kv", "Focus", "AI/ML, NLP, CV, full-stack apps"),
    ("kv", "Skills", "Python, Java, JS, React, Node"),
    ("kv", "Base", "Ahmedabad, Gujarat"),
    ("gap",),
    ("sec", "Technical Skills"),
    ("bul", "Languages: Python, Java, JavaScript, React, Node, Next, Express, C++, C, SQL"),
    ("bul", "ML / DL: Scikit-learn, PyTorch, NumPy, Pandas, XGBoost, Random Forest, KNN"),
    ("bul", "LLMs & NLP: Hugging Face, LangChain, FAISS, BERT, GPT API, RAG pipelines"),
    ("bul", "CV: torchvision, Grad-CAM, OpenCV"),
    ("bul", "MLOps: Jupyter, Colab, Git, VS Code"),
    ("bul", "Evaluation: Accuracy, Precision, Recall, F1-score, confusion matrix, Top-k Recall"),
]
